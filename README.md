...
- `spip matrix <pkg> [test.py]`: Build-server mode. Tests all available versions of a package for installability and compatibility using a custom or AI-generated test script.
